...
namespace UltimateTruckEmpire.Gameplay
{
    ...
    public static class RouteProgression
    {
        private static readonly RouteDefinition[] Routes =
        {
            ...
            new RouteDefinition { id = "GJ-SUR-RAJ", origin = "Surat", destination = "Rajkot", tier = RouteTier.National, requiredContracts = 5, minDistanceKm = 350f, maxDistanceKm = 470f, minCargoTons = 10f, maxCargoTons = 28f, baseDifficulty = 3 },
