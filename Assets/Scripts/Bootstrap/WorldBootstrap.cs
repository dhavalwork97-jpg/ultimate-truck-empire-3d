...
namespace UltimateTruckEmpire.Bootstrap
{
    public sealed class WorldBootstrap : MonoBehaviour
    {
        ...
        private static void BuildWorld()
        {
            ...
            CreateLight();
            CreateRoad(new Vector3(0, -0.15f, 0), new Vector3(180, .3f, 14));
            CreateRoad(new Vector3(0, -0.15f, 70), new Vector3(180, .3f, 14));
            CreateRoad(new Vector3(0, -0.15f, -70), new Vector3(180, .3f, 14));
        ...
        private static void CreateLight()
        {
            ...
            go.transform.rotation = Quaternion.Euler(48, -30, 0);
        }

        private static void CreateRoad(Vector3 position, Vector3 scale)
        {
            var road = GameObject.CreatePrimitive(PrimitiveType.Cube);
            road.name = "Road"; road.transform.position = position; road.transform.localScale = scale;
        }
