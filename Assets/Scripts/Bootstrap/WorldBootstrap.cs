...
namespace UltimateTruckEmpire.Bootstrap
{
    public sealed class WorldBootstrap : MonoBehaviour
    {
        ...
        private static void BuildWorld()
        {
            ...
            CreateTruck(new Vector3(-20, 1.1f, 0));
            CreateHud();
        }
        ...
        {
            var truck = new GameObject("Player Truck"); truck.tag = "PlayerTruck"; truck.transform.position = position; var body = truck.AddComponent<Rigidbody>(); body.mass = 8000; body.centerOfMass = new Vector3(0, -.7f, 0);
        ...
        private static void CreateHud()
        {
            ...
            var textGo = new GameObject("HUD Text"); textGo.transform.SetParent(canvasGo.transform); var text = textGo.AddComponent<Text>(); text.font = Resources.GetBuiltinResource<Font>("LegacyRuntime.ttf"); text.fontSize = 24; text.alignment = TextAnchor.UpperLeft;
            text.text = "ULTIMATE TRUCK EMPIRE\n\nWASD / Arrows Drive   SPACE Brake   I Engine   L Lights\nF1 Fleet   F2 Drivers   F3 Contracts   F4 Finances   F5 Company\n\nDRIVE THE TRUCK. BUILD THE COMPANY. CREATE THE EMPIRE.";
            var rt = text.rectTransform; rt.anchorMin = new Vector2(0, 1); rt.anchorMax = new Vector2(0, 1); rt.pivot = new Vector2(0, 1); rt.anchoredPosition = new Vector2(24, -24); rt.sizeDelta = new Vector2(760, 300); DeliveryManager.Instance?.AcceptStarterContract();
        }
    }
}
