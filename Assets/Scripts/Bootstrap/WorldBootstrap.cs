...
namespace UltimateTruckEmpire.Bootstrap
{
 public sealed class WorldBootstrap:MonoBehaviour
 {
  ...
  private static void EnsureManagementUI(){if(FindFirstObjectByType<ManagementUI>()==null)new GameObject("Management UI").AddComponent<ManagementUI>();if(FindFirstObjectByType<ManagementActionUI>()==null)new GameObject("Management Actions").AddComponent<ManagementActionUI>();}
