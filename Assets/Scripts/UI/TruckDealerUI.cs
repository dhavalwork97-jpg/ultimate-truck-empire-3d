...
namespace UltimateTruckEmpire.UI
{
    public sealed class TruckDealerUI : MonoBehaviour
    {
        ...
        private void Build()
        {
            var root = new GameObject("Truck Dealership Canvas");
            ...
            var title = AddText(panel.transform, "TRUCK DEALERSHIP\nSelect a truck to compare specs and purchase it for your fleet.", 24, TextAnchor.UpperLeft);
        ...
        private void Close(){var canvas=GetComponentInChildren<Canvas>();if(canvas!=null)canvas.gameObject.SetActive(false);}
