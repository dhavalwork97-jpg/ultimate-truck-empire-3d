...
namespace UltimateTruckEmpire.Company
{
    ...
    public sealed class TruckCatalogEntry
    {
        ...
        public TruckCatalogEntry(string manufacturer, string model, float price, float capacityTons, float fuelCapacity, float powerHp, float torqueNm, float maxSpeedKph, float fuelEfficiency, string drivetrain)
        {
    ...
    public sealed class TruckDealer : MonoBehaviour
    {
        ...
        {
            catalog.Clear();
            catalog.Add(new TruckCatalogEntry("UTE Motors", "Hauler 300", 180000f, 30f, 500f, 320f, 1450f, 110f, 7.2f, "6x4"));
            catalog.Add(new TruckCatalogEntry("UTE Motors", "Hauler 500", 285000f, 36f, 620f, 410f, 1900f, 115f, 6.8f, "6x4"));
            catalog.Add(new TruckCatalogEntry("Bharat Forge Trucks", "Atlas 420", 340000f, 40f, 650f, 420f, 2050f, 115f, 6.6f, "6x4"));
            catalog.Add(new TruckCatalogEntry("Bharat Forge Trucks", "Atlas X 520", 495000f, 45f, 760f, 520f, 2400f, 120f, 6.1f, "8x4"));
            catalog.Add(new TruckCatalogEntry("Western Starline", "Titan 600", 680000f, 50f, 850f, 600f, 2800f, 120f, 5.7f, "8x4"));
            catalog.Add(new TruckCatalogEntry("Western Starline", "Titan Heavy 750", 950000f, 65f, 1050f, 750f, 3400f, 105f, 4.9f, "8x8"));
        }

        public FleetTruckData Purchase(TruckCatalogEntry entry)
        {
            if (entry == null || FleetManager.Instance == null) return null;
